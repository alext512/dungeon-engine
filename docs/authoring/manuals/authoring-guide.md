...
- `font_id`
Optional font override. Font ids are the JSON filename (without extension) of a bitmap font definition under the project's `assets/.../fonts/` folder. See [Engine JSON Interface](engine-json-interface.md) for the font definition format.
- `max_lines`
