...
- Project command file metadata is owned by `dungeon_engine/commands/library.py`, including `inputs`, `params`, `deferred_param_shapes`, and strict top-level field validation.
